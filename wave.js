...
const x0=-w*.22,x1=w*1.22,step=Math.max(6,w/175),yBase=h*(.75+(i-2)*.026),amplitude=h*(.052+(i%3)*.019),thickness=h*(.050+(i%4)*.019),phase=i*1.09,points=[];
